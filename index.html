...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="images/cdu.ico" type="image/x-icon">
      ...
      <tr style="padding:0px">
		...
		I've received the <a href="https://www.thecvf.com/?page_id=413#YRA">PAMI Young Researcher Award</a>.
              ...
              <td style="padding:2.5%;width:37%;max-width:37%">
                <a href="images/ZAID.jpg"><img style="width:100%;max-width:100%;object-fit: cover; border-radius: 50%;" alt="profile photo" src="images/JonBarron.jpg" class="hoverZoomLink"></a>
              </td>
            </tr>
          </tbody></table>
          <table style="width:100%;border:0px;border-spacing:0px;border-collapse:separate;margin-right:auto;margin-left:auto;"><tbody>
